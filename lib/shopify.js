...
export function normalizeProduct(p) {
  ...
  // Derive brand from collections (Shopify vendor field contains supplier names, not brand names)
  ...
  const brandName = brandCollection?.title ?? p.vendor;
  const brandHandle = brandCollection?.handle ?? null;
